...
const onAnchorClickedListener = function onItemClicked(event,anchor){
    ...
    selectedSectionElement.classList.toggle('your-active-class')
}
...
function addItemsToNavMenu(navItems,sectionsIds){
    ...
    for(let index=0; index<navItems.length;index++){
        ...
        navListItemAnchor.addOnEventListener('click',(event)=>onAnchorClickedListener(event,navListItemAnchor))
